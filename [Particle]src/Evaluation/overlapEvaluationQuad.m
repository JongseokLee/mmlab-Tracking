function [ overlapRate frameIndex ] = overlapEvaluationQuad(rsCorners, gtCorners)
...
gtLength = size(gtCorners,2);
overlapRate = zeros(1, gtLength);
overlapRate(1) = 1.0;
for num = 1:gtLength
    overlapRate(num+1) = calculateOverlapRate(rsCorners{num},... 
                                            gtCorners{num},...
                                            'quadrilateral');
end
